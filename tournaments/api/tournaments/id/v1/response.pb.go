...
type PatchTournamentResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PatchTournamentResponse) Reset() {
	*x = PatchTournamentResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PatchTournamentResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PatchTournamentResponse) ProtoMessage() {}

func (x *PatchTournamentResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_tournaments_id_v1_response_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PatchTournamentResponse.ProtoReflect.Descriptor instead.
func (*PatchTournamentResponse) Descriptor() ([]byte, []int) {
	return file_api_tournaments_id_v1_response_proto_rawDescGZIP(), []int{1}
}

func (x *PatchTournamentResponse) GetTournament() *v1.Tournament {
	if x != nil {
		return x.Tournament
	}
	return nil
...
func (x *DeleteTournamentResponse) Reset() {
	*x = DeleteTournamentResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_tournaments_id_v1_response_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteTournamentResponse) Descriptor() ([]byte, []int) {
	return file_api_tournaments_id_v1_response_proto_rawDescGZIP(), []int{2}
}
...
var file_api_tournaments_id_v1_response_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x75, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x74,
...
var file_api_tournaments_id_v1_response_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_api_tournaments_id_v1_response_proto_goTypes = []any{
	...
	(*PatchTournamentResponse)(nil),  // 1: api.tournaments.id.v1.PatchTournamentResponse
	(*DeleteTournamentResponse)(nil), // 2: api.tournaments.id.v1.DeleteTournamentResponse
	(*v1.Tournament)(nil),            // 3: model.tournament.v1.Tournament
}
var file_api_tournaments_id_v1_response_proto_depIdxs = []int32{
	3, // 0: api.tournaments.id.v1.GetTournamentResponse.tournament:type_name -> model.tournament.v1.Tournament
	3, // 1: api.tournaments.id.v1.PatchTournamentResponse.tournament:type_name -> model.tournament.v1.Tournament
...
func file_api_tournaments_id_v1_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_tournaments_id_v1_response_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*PatchTournamentResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_tournaments_id_v1_response_proto_msgTypes[2].Exporter = func(v any, i int) any {
